...
SKH.init = function(p) {
    ...
    var shackhand = angular.module("shackhand",
  ...
  +                    'ng-src="{{(bases[0].hands[total - k].id && \'http://graph.facebook.com/\' + bases[0].hands[total - k].id + \'/picture\') || \'img/marker-icon.png\'}}"/>'
      ...
      //       +'</a>'
        ...
        +'</div>'
          ...
          }).controller('SKH-Ctrl', function($scope, leafletEvents, $firebase, $filter, $timeout,  $localStorage, $localStorage){
...
/*
 ...
 //               $scope.$apply();
            ...
            //        console.log(d);
                    ...
                    if (lat) $scope.local.zoom = p.zoom || 13;
